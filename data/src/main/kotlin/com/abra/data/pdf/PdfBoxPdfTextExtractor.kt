    ...
    override suspend fun extract(
        ...
        runCatching {
            ...
            val inputStream = context.contentResolver.openInputStream(uri)
                ?: return@withContext PdfExtractionResult.Failure("Unable to open PDF file.")
                ...
                PDDocument.load(stream).use { document ->
                    ...
                    if (segments.isEmpty()) {
                        PdfExtractionResult.Unsupported(
                            reason = "No selectable text was found. Scanned PDFs require OCR, which is out of scope for the MVP.",
                            pageCount = document.numberOfPages
                        )
                    } else {
